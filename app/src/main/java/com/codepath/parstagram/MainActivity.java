...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE = 42; // arbitrary + unique
...
//        queryPosts();
    ...
    private void savePost(String desciption, ParseUser currentUser, File photoFile) {
        Post post = new Post();
